  ...
  return (
    <div className="border-b-[1px] border-neutral-800 px-5 py-2">
      {currentUser ? (
        <div className="flex flex-row gap-4">
          ...
          <div className="w-full">
            <textarea
              ...
              className="disabled:opacity-80 peer resize-none mt-3 w-full bg-black dark:bg-slate-200 px-2 ring-0 outline-none text-[20px] placeholder-neutral-500 text-white"
            ></textarea>
        ...
        <div className="py-8">
          <h1 className="text-white dark:text-black text-2xl text-center mb-4 font-bold">
            Welcome to Twitter
          </h1>
